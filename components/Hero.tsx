  ...
  return (
    <section className="relative w-full h-screen overflow-hidden font-sans selection:bg-[#00ac49] selection:text-white flex items-center justify-center bg-black">
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute inset-0 opacity-[0.04] z-10 pointer-events-none mix-blend-overlay"
          style={{
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 md:px-12 h-full flex flex-col justify-center">
        ...
        <div
          className={`w-full border-t border-white/10 pt-4 mt-12 flex flex-col md:flex-row justify-center md:justify-between items-center text-white/50 backdrop-blur-sm transition-all duration-1000 delay-300 ${
